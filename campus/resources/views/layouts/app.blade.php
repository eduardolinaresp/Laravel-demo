...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.min.css" integrity="sha384-O/61W5+JcqpaKJvGYKd2WFU6LmUZmj6tnkyaunOvHcQ+NzAgIR51q2t2xOoGg86z" crossorigin="anonymous">
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                ...
                @auth
                <a class="navbar-nav " href="{{ route('clientes.index') }}">
                        {{ __('Clientes') }}
                </a>
                @endauth
